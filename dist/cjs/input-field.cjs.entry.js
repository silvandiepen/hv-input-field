...
const InputField = class {
    ...
    render() {
        return (core.h("div", { class: "input-field" }, this.description ? (core.h("div", { class: "input-field__description" }, this.description)) : (core.h("div", null)), " ", this.errorMessage && this.error ? (core.h("div", { class: "input-field__error" }, this.errorMessage)) : (core.h("div", null)), core.h("slot", { name: "after" }), core.h("input", { onBlur: event => this.handleBlur(event), onInput: event => this.handleChange(event), class: "input-field__input", value: this.value, id: this.elementId, name: this.name, placeholder: this.placeholder, required: this.required }), core.h("label", { class: "input-field__label" }, core.h("span", { class: "input-field__text" }, this.label, this.optional ? (core.h("span", { class: "input-field__optional" }, "(optional)")) : (``))), core.h("slot", { name: "before" })));
    }
