...
const InputField = class {
    ...
    render() {
        return (h("div", { class: "input-field" }, this.description ? (h("div", { class: "input-field__description" }, this.description)) : (h("div", null)), " ", this.errorMessage && this.error ? (h("div", { class: "input-field__error" }, this.errorMessage)) : (h("div", null)), h("slot", { name: "after" }), h("input", { onBlur: event => this.handleBlur(event), onInput: event => this.handleChange(event), class: "input-field__input", value: this.value, id: this.elementId, name: this.name, placeholder: this.placeholder, required: this.required }), h("label", { class: "input-field__label" }, h("span", { class: "input-field__text" }, this.label, this.optional ? (h("span", { class: "input-field__optional" }, "(optional)")) : (``))), h("slot", { name: "before" })));
    }
