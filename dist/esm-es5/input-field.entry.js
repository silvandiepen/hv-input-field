import { r as registerInstance, h } from './core-673eb52f.js';
var InputField = /** @class */ (function () {
    ...
    InputField.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "input-field" }, this.description ? (h("div", { class: "input-field__description" }, this.description)) : (h("div", null)), " ", this.errorMessage && this.error ? (h("div", { class: "input-field__error" }, this.errorMessage)) : (h("div", null)), h("slot", { name: "after" }), h("input", { onBlur: function (event) { return _this.handleBlur(event); }, onInput: function (event) { return _this.handleChange(event); }, class: "input-field__input", value: this.value, id: this.elementId, name: this.name, placeholder: this.placeholder, required: this.required }), h("label", { class: "input-field__label" }, h("span", { class: "input-field__text" }, this.label, this.optional ? (h("span", { class: "input-field__optional" }, "(optional)")) : (""))), h("slot", { name: "before" })));
    };
